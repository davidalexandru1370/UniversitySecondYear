...
fprintf("We need the standard deviation of x so we use the second case from the confidence interval file and compute using chi 2.\n")
fprintf("This gives us the variance so we need to square root in order to convert to standard deviation\n");
...
fprintf("The interval is (%4.3f, %4.3f)\n",s1,s2);